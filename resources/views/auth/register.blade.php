                            ...
                            <form method="POST" action="{{ URL::to('login/doregister') }}">
                                @csrf
                                 <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="nama" placeholder="Nama Asli">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-default btn-block" style="color:#c0a143;">Daftar</button> <br>
                                    </div>
                                    <!-- /.col --> 
                                    <div class="col-12" style="text-align: -webkit-center;">
                                        <a href="{{ URL::to('login') }}" class="btn btn-default btn-block text-center" style="color:#c0a143;width: max-content;">Login</a>
                                    </div>
                                    <!-- /.col -->
                                </div>
                            </form>

                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th colspan="3">Syarat Perlu Terakreditasi : </th>
                                <th colspan="2">
                                    <?php if($syarat[15] == 'Terpenuhi' AND $syarat[22] == 'Terpenuhi' AND $syarat[44] == 'Terpenuhi'){
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <?php if($syarat[23] == 'Terpenuhi' AND $syarat[24] == 'Terpenuhi' AND $syarat[77] == 'Terpenuhi' AND $syarat[78] == 'Terpenuhi'){
                                        echo '<span style="background: greenyellow;padding: 5px;color: white;">Terpenuhi</span>';
                                    }else{
                                        echo '<span style="background: red;padding: 5px;color: white;">Tidak Terpenuhi</span>';
                                    } ?>
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <?php if($syarat2[23] == 'Terpenuhi' AND $syarat2[24] == 'Terpenuhi' AND $syarat2[77] == 'Terpenuhi' AND $syarat2[78] == 'Terpenuhi'){
                                        echo '<span style="background: greenyellow;padding: 5px;color: white;">Terpenuhi</span>';
                                    }else{
                                        echo '<span style="background: red;padding: 5px;color: white;">Tidak Terpenuhi</span>';
                                    } ?>

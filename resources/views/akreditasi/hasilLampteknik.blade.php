                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <?php if($syarat[111] == 'Terpenuhi' AND $syarat[133] == 'Terpenuhi' ){
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <?php if($syarat[112] == 'Terpenuhi' AND $syarat[113] == 'Terpenuhi' AND $syarat[168] == 'Terpenuhi' AND $syarat[169] == 'Terpenuhi'){
                                        echo '<span style="background: greenyellow;padding: 5px;color: white;">Terpenuhi</span>';
                                    }else{
                                        echo '<span style="background: red;padding: 5px;color: white;">Tidak Terpenuhi</span>';
                                    } ?>
                            ...
                            <tr>
                                ...
                                <th colspan="2">
                                    <?php if($syarat2[112] == 'Terpenuhi' AND $syarat2[113] == 'Terpenuhi' AND $syarat2[168] == 'Terpenuhi' AND $syarat2[169] == 'Terpenuhi'){
                                        echo '<span style="background: greenyellow;padding: 5px;color: white;">Terpenuhi</span>';
                                    }else{
                                        echo '<span style="background: red;padding: 5px;color: white;">Tidak Terpenuhi</span>';
                                    } ?>
